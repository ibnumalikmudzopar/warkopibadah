  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        // Untuk menampilkan kalkulator, Anda bisa mengganti `home: const WidgetTree()` dengan `home: const CalculatorView()`
        // atau menambahkan navigasi ke CalculatorView dari WidgetTree.
